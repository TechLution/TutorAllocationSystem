...
$handler = new PDO("mysql:host=localhost;dbname=d1431410", 'root', '', $options);
...
.modal {
  ...
  background-color: light-grey; /* Fallback color */
  background-color: light-grey; /* Black w/ opacity */
}
                    ...
                    <?php foreach ($students as $student) : ?>
                       <div id="<?php $pop= explode(" ",$student); echo $pop[2];?> 
                            ...
                            style = <?php if ($pop[8] == "Applied"){
                                    echo "background-color:light-grey;";
                            }
                            else if ($pop[8] == "Accepted"){
                                echo "background-color:#3FFF00;";
                            } 
                            ...
                            > 
                                ...
                                <?php $pop= explode(" ",$student); echo $pop[2].".";?> 
...
<h4 class="$student"><?phpecho $student?></h4>
  ...
  function reply_click(clicked_id)
  {
    ...
    var url = "http://localhost/New/pop.php?applicant_ID="+clicked_id;
...
function updateStatus(course_ID,applicant_ID){
    ...
    var url = "http://localhost/New/UpdateStatus.php?applicant_ID="+applicant_ID+"&course_ID="+course_ID+"&status="+status;
    var ajax = new XMLHttpRequest();
    var method = "GET";
